    ...
    private function attachHydrator()
    {
        ...
        switch ($mode) {
            case Query::HYDRATE_OBJECT:
                $this->getQuery()->setHydrationMode(Configuration::HYDRATE_OBJECT);
                break;
            case Query::HYDRATE_ARRAY:
                $this->getQuery()->setHydrationMode(Configuration::HYDRATE_ARRAY);
                break;
            case Query::HYDRATE_SCALAR:
                $this->getQuery()->setHydrationMode(Configuration::HYDRATE_SCALAR);
                break;
            case Query::HYDRATE_SINGLE_SCALAR:
                $this->getQuery()->setHydrationMode(Configuration::HYDRATE_SINGLE_SCALAR);
                break;
            case Query::HYDRATE_SIMPLEOBJECT:
                $this->getQuery()->setHydrationMode(Configuration::HYDRATE_SIMPLEOBJECT);
                break;
        }
    }
}